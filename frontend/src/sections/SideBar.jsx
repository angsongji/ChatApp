...
const SideBar = () => {
  ...
  const { chattedUsers } = useChatStore();
  return (
    <div
      className={`transition duration-400 ease-in-out flex flex-col min-h-fit w-full md:w-1/4 md:h-full max-h-[100vh] md:scale-100 md:translate-y-0 absolute md:relative z-10 top-0 left-0 md:left-0 md:translate-x-0
